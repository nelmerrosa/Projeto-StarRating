<footer id="footer">
    <div id="social-container">
        <ul>
            <li>
                <a href="https://www.facebook.com/nelmer.rosa/" target="_blank"><i class="fab fa-facebook-square"></i></a>
            </li>
            <li>
                <a href="https://www.instagram.com/salvi.nel/" target="_blank"><i class="fab fa-instagram"></i></a>
            </li>
            <li>
    ...
    <div id="footer-links-container">
        <ul>
            ...
            <li><a href="movie.php">Adicionar Crítica</a></li>
            <li><a href="#">Entrar / Cadastrar</a></li>
        </ul>
    </div>
    <p>&copy; 2020 - Nelmer</p>
</footer>
<!-- BOOTSTRAP JS -->
