...
<div id="main-container" class="container-fluid">
    ...
    <p class="section-description">Adicione ou atualize as informações dos filmes que você já avaliou!</p>
                ...
                <?php foreach ($userMovies as $movie) : ?>
                    <tr>
                        ...
                        <td class="actions-column">
                            ...
                            <form action="<?= $BASE_URL ?>movie_process.php" method="POST"> <br>
